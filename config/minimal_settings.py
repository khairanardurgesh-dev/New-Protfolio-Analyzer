"""
ULTRA-MINIMAL DJANGO SETTINGS
Absolutely no imports, no complex configuration, no potential issues
"""
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-ultra-minimal-key-for-deployment')
...
# Application definition - ABSOLUTELY MINIMAL
INSTALLED_APPS = [
    ...
    'analyzer',  # Just the app name, no config class
]
